...
const TicTacToe = () => {
  ...
  const won = (winner) => {
    ...
    if (winner === "x") {
      titleRef.current.innerHTML = `Congratulations <img src = "${cross_icon}"> has won the game `;
    }

    if (winner === "o") {
      titleRef.current.innerHTML = `Congratulations <img src = "${circle_icon}"> has won the game `;
    }
